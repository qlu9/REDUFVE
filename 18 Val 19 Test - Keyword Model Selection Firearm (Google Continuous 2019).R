...
data_orig <- read.xlsx('combined_google_weekly.xlsx', sheetIndex = 2, header = TRUE)
...
model_both_lr = lm(Actual.Firearm ~ Gun + Rifle + Pistol. + Homicide + Murder + 
                     Gun.shot + Gun.violence
                       ,data = train)
...
model_rf_lr = lm(Actual.Firearm ~ Gun + Shooting + Rifle + X9mm + Homicide + Murder + Gun.shot
                 ,data = train)
...
data2 <- read.xlsx('combined_google_weekly.xlsx', sheetIndex = 2, header = TRUE)
...
model_backward_svr = svm(Actual.Firearm ~ Gun + Rifle + Pistol. + Homicide + Murder + 
                           Gun.shot + Gun.violence
                         ,data = train2)
...
tuned_svr = tune(svm, Actual.Firearm ~ Gun + Rifle + Pistol. + Homicide + Murder + 
                   Gun.shot + Gun.violence
...
model_rf_svr = svm(Actual.Firearm ~ Gun + Shooting + Rifle + X9mm + Homicide + Murder + Gun.shot
                   ,data = train2)
...
data3 <- read.xlsx('combined_google_weekly.xlsx', sheetIndex = 2, header = TRUE)
...
model_backward_rf = randomForest(Actual.Firearm ~ Gun + Rifle + Pistol. + Homicide + Murder + 
                                   Gun.shot + Gun.violence
                                 ,data = train3)
...
model_rf_rf = randomForest(Actual.Firearm ~ Gun + Shooting + Rifle + X9mm + Homicide + Murder + Gun.shot
                           ,data = train3)
