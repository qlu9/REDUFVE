...
data_orig <- read.xlsx('combined_youtube_weekly.xlsx', sheetIndex = 2, header = TRUE)
data_full <- data_orig %>% slice(1:208)
...
data <- read.xlsx('combined_youtube_weekly.xlsx', sheetIndex = 2, header = TRUE)
train = data %>% slice(105:208)
test = data %>% slice(209:260)

model_forward_lr = lm(Actual.Firearm ~ Gun + Shooting + Shotgun + Rifle + X9mm + Pistol. + 
                        Homicide + Murder + Gun.shot + Gun.violence
                      ,data = train)
...
model_backward_lr = lm(Actual.Firearm ~ Gun + Shooting + Pistol. + Murder + Gun.shot + 
                         Gun.violence
                       ,data = train)
...
model_both_lr = lm(Actual.Firearm ~ Gun + Shooting + Pistol. + Murder + Gun.shot + 
                     Gun.violence
                       ,data = train)
pred.train_bolr = predict(model_both_lr, train)
pred.test_bolr = predict(model_both_lr, test)
rmse_train_bolr <- sqrt((sum((train$Actual.Firearm - pred.train_bolr)^2))/104)
rmse_test_bolr <- sqrt((sum((test$Actual.Firearm - pred.test_bolr)^2))/52)
rmse_train_bolr
rmse_test_bolr



model_rf_lr = lm(Actual.Firearm ~ Shooting + X9mm + Pistol. + Gun.shot
                 ,data = train)
...
model_forward_svr = svm(Actual.Firearm ~ Gun + Shooting + Shotgun + Rifle + X9mm + Pistol. + 
                          Homicide + Murder + Gun.shot + Gun.violence
                        ,data = train2)
...
model_backward_svr = svm(Actual.Firearm ~ Gun + Shooting + Pistol. + Murder + Gun.shot + 
                           Gun.violence
                         ,data = train2)
...
tuned_svr = tune(svm, Actual.Firearm ~ Gun + Shooting + Pistol. + Murder + Gun.shot + 
                   Gun.violence
...
model_rf_svr = svm(Actual.Firearm ~ Shooting + X9mm + Pistol. + Gun.shot
                   ,data = train2)
...
data3 <- read.xlsx('combined_youtube_weekly.xlsx', sheetIndex = 2, header = TRUE)
train3 = data3 %>% slice(105:208)
test3 = data3 %>% slice(209:260)

model_forward_rf = randomForest(Actual.Firearm ~ Gun + Shooting + Shotgun + Rifle + X9mm + Pistol. + 
                                  Homicide + Murder + Gun.shot + Gun.violence
                                ,data = train3)
...
model_backward_rf = randomForest(Actual.Firearm ~ Gun + Shooting + Pistol. + Murder + Gun.shot + 
                                   Gun.violence
                                 ,data = train3)
...
model_rf_rf = randomForest(Actual.Firearm ~ Shooting + X9mm + Pistol. + Gun.shot
                           ,data = train3)
